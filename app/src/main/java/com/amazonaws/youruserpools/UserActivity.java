...
public class UserActivity extends AppCompatActivity {
    ...
    private void getDetails() {
        AppHelper.getPool().getCurrentUser().getDetailsInBackground(detailsHandler);
    }
    ...
    GetDetailsHandler detailsHandler = new GetDetailsHandler() {
        ...
        public void onFailure(Exception exception) {
            closeWaitDialog();
            showDialogMessage("Could not fetch user details!", AppHelper.formatException(exception), false);
        }
    };
